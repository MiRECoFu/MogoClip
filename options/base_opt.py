...
class BaseOptions():
    ...
    def initialize(self):
        self.parser.add_argument('--name', type=str, default="mogo_clip_768_1207", help='Name of this trial')
        ...
        self.parser.add_argument('--layers', type=int, default=16, help='Number of attention layers.')
